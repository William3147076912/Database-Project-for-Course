...
public class CourseEnrollmentController extends BaseController
{
    ...
    {
        startPage();
        List<CourseEnrollment> list = courseEnrollmentService.selectCourseEnrollmentList(courseEnrollment);
    ...
    {
        List<CourseEnrollment> list = courseEnrollmentService.selectCourseEnrollmentList(courseEnrollment);
        ExcelUtil<CourseEnrollment> util = new ExcelUtil<CourseEnrollment>(CourseEnrollment.class);
